...
<<<<<<< HEAD
* [ðYŒ± Install](#-install)
* [ðY—i¸ Usage (.env)](#%EF%B8%8F-usage)
* [ðYŒ´ Multiple Environments ðY†•](#-manage-multiple-environments)
* [ðYs€ Deploying (encryption) ðY†•](#-deploying)
* [ðY“s Examples](#-examples)
* [ðY“– Docs](#-documentation)
* [a“ FAQ](#-faq)
* [a±i¸ Changelog](./CHANGELOG.md)
...
>
<<<<<<< HEAD
> It serves the same purpose (you do not need to require and load dotenv), adds better debugging, and works with ANY language, framework, or platform. a€“ [motdotla](https://github.com/motdotla)
=======
...
<<<<<<< HEAD
## ðYŒ´ Manage Multiple Environments
=======
...
<<<<<<< HEAD
> In a twelve-factor app, env vars are granular controls, each fully orthogonal to other env vars. They are never grouped together as a€œenvironmentsa€, but instead are independently managed for each deploy. This is a model that scales up smoothly as the app naturally expands into more deploys over its lifetime.
>
> a€“ [The Twelve-Factor App](http://12factor.net/config)
=======
...
>
<<<<<<< HEAD
> a€“ [ES6 In Depth: Modules](https://hacks.mozilla.org/2015/08/es6-in-depth-modules/)
=======
