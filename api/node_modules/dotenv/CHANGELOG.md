...
<<<<<<< HEAD
- Default `quiet` to true a€“ hiding the runtime log message ([#874](https://github.com/motdotla/dotenv/pull/874))
=======
...
<<<<<<< HEAD
- ðYZ‰ Added new sponsor [Graphite](https://graphite.dev/?utm_source=github&utm_medium=repo&utm_campaign=dotenv) - *the AI developer productivity platform helping teams on GitHub ship higher quality software, faster*.
=======
...
<<<<<<< HEAD
- ðYz Fix recent regression when using `path` option. return to historical behavior: do not attempt to auto find `.env` if `path` set. (regression was introduced in `16.4.3`) [#814](https://github.com/motdotla/dotenv/pull/814)
=======
...
<<<<<<< HEAD
- ðYz Replaced chaining operator `?.` with old school `&&` (fixing node 12 failures) [#812](https://github.com/motdotla/dotenv/pull/812)
=======
...
<<<<<<< HEAD
- Add `.env.vault` support. ðYZ‰ ([#730](https://github.com/motdotla/dotenv/pull/730))

a„¹i¸ `.env.vault` extends the `.env` file format standard with a localized encrypted vault file. Package it securely with your production code deploys. It's cloud agnostic so that you can deploy your secrets anywhere a€“A without [risky third-party integrations](https://techcrunch.com/2023/01/05/circleci-breach/). [read more](https://github.com/motdotla/dotenv#-deploying)
=======
...
<<<<<<< HEAD
- _Breaking:_ Backtick support ðYZ‰ ([#615](https://github.com/motdotla/dotenv/pull/615))
=======
...
<<<<<<< HEAD
- Properly parse empty single or double quoted values ðYz ([#614](https://github.com/motdotla/dotenv/pull/614))
=======
...
<<<<<<< HEAD
- Preserve backwards compatibility on values containing `#` ðYz ([#603](https://github.com/motdotla/dotenv/pull/603))
=======
...
<<<<<<< HEAD
- Preserve backwards compatibility on exports by re-introducing the prior in-place exports ðYz ([#606](https://github.com/motdotla/dotenv/pull/606))
=======
...
<<<<<<< HEAD
- Add `multiline` option ðYZ‰ ([#486](https://github.com/motdotla/dotenv/pull/486))
=======
...
<<<<<<< HEAD
- Add `override` option ðYZ‰ ([#595](https://github.com/motdotla/dotenv/pull/595))
=======
...
<<<<<<< HEAD
- _Breaking:_ Support inline comments for the parser ðYZ‰ ([#568](https://github.com/motdotla/dotenv/pull/568))
=======
